...
const maxYearAvg = updatedData.reduce(
  (max, obj) => (obj.YearAvg > max.YearAvg ? obj : max),
  updatedData[0]
);
const minYearAvg = updatedData.reduce(
  (min, obj) => (obj.YearAvg < min.YearAvg ? obj : min),
  updatedData[0]
);
</script>
  ...
  <div>
    ...
    <div v-if="temperatureData.length > 0">
      <TemperatureLineChart
        ...
        :maxYearAvg="maxYearAvg.YearAvg"
        :minYearAvg="minYearAvg.YearAvg"
      />
    </div>
    <div v-else>
